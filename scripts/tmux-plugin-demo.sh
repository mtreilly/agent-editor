...
tmux send-keys -t "$SESSION":0.1 'cd cli && go build -o agent-editor ./cmd/agent-editor && cd .. && ./cli/agent-editor plugin start-core echo --exec node -- plugins/echo-core/echo.cjs' C-m
sleep 1
